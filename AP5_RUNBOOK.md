...
**Ревью источника отвечало 500 — исправлено.** Решение по источнику пишет
...
Звено 4 в `02-kora-chain.spec.ts` теперь проходит целиком: поверхность
предлагает ревизию, команда её подтверждает, чтение показывает `confirmed`.
