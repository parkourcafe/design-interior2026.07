# AGENTS.md — ArchiDom RU / Product Charter v0.4
...
Публичный российский продукт называется **ArchiDom**. `ProjectCEO` сохраняется
...
- Все пользовательские строки находятся в `lib/i18n/ru.ts`; публичный copy использует
  ArchiDom и названия четырёх рабочих пространств после отдельного UI acceptance gate.
