...
- обмен и импорт (решение владельца 08.08.2026, вариант B — A2 §3): наружу
  ...
  обводка не порождает подписанных размеров (A2 §3.3); до получения живого
  .dwg реализация подложки не начинается (A2 §3.2); запасной вариант — A,
...
на сервере как подложки (границы — A2 §3). Размеры — это
