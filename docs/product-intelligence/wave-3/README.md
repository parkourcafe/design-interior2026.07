# ProjectCEO RU — Wave 3

Рабочий пакет подготовки pilot-ready P0:

1. [Master execution plan](./MASTER_EXECUTION_PLAN.md)
2. [ТЗ агента 1 — Core/DB/Access](./AGENT_1_CORE_DB_ACCESS.md)
3. [ТЗ агента 2 — Project Brain/Kora](./AGENT_2_PROJECT_BRAIN_KORA.md)
