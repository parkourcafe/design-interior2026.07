...
- Output contains no raw URL, redirect, token, storage key or source path.
  Display labels reject slash-bearing paths, leading URI schemes and control
  characters.
...
| `npm run test` | PASS, 216 files / 1792 tests on the final tree |
| `npm run build -- --webpack` | PASS, 46 static pages generated |
| focused viewer tests | PASS, 38 tests |
...
1792/1792. Scanner code and tests were not changed.
