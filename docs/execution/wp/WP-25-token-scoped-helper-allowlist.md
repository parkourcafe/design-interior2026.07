...
- входов нет: черновик решения Р26 готовит сам этот пакет, подпись владельца — в критерии приёмки
...
- владелец подписал Р26 по черновику из этого PR (до подписи пакет остаётся `PR_OPEN`)
