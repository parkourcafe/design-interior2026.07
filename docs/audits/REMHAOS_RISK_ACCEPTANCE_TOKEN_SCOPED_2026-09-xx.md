# Р26 — существующие service-role исключения

**ПРИНЯТО ВЛАДЕЛЬЦЕМ.** Дата решения: 2026-09-09.
Пакет WP-25. Подпись/дословное подтверждение владельца: `parkourcafe`.
...
срок и условия временного риска. Владелец определил их ниже; WP-26 остаётся
обязательным для дальнейшего снятия риска.
...
- Дата: 2026-09-09.
- Срок действия: до завершения и принятия WP-26.
- Условия: только текущие allowlisted token-scoped маршруты; production и
  новые маршруты не разрешены; WP-26 обязателен для дальнейшего снятия риска.
- Подпись владельца: `parkourcafe`.
