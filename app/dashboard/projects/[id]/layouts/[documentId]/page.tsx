 ...
 * пустого кадра. Дальше он сохраняет через /api/layout-studio, поэтому сюда
 * приходит storage="server": документ живёт в базе, а не в localStorage.
 *
...
export default async function ProjectLayoutEditorPage({
  ...
  return (
    <>
      ...
      <LayoutStudioShell initialDocument={row.draft} storage="server" />
    </>
  );
}
