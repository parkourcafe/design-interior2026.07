...
export function nextR1DeliveryRange(input: { readonly start: number; readonly totalBytes: number; readonly grantActive: boolean }) {
  if (!input.grantActive) throw new Error("r1_delivery_grant_denied");
