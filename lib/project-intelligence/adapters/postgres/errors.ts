 ...
 *
 * Зачем это нужно отдельно от кода. Один `P1111` несёт совершенно разные
 * исходы: `IMPACT_ALREADY_CALCULATED` означает «работа уже сделана»,
 * `IMPACT_DEPTH_TRUNCATED` — «считать отказались, нужен человек». Системному
 * воркеру приходится их различать, а `validation_failed` одинаков для обоих.
 *
