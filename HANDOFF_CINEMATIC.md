# HANDOFF — Кинематографичный сайт ARHIDOM (исторический снимок)

> **УСТАРЕЛО.** Этот снимок от 07.07.2026 сохранён только как историческая
> сноска о раннем ARHIDOM-контуре. Он не описывает текущие RemHaOS, `main`,
> owner-controlled `release` или production adoption. Для текущей работы
> использовать `HANDOFF.md`, `docs/execution/REMHAOS_MASTER_TZ_2026-09-08.md`
> и `docs/audits/REMHAOS_COMPLETION_ROADMAP_2026-09-08.md`.
