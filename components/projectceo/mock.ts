...
const changes: readonly ChangeRequestView[] = [
  {
    ...
    impactTruncationReason: "depth_limit",
    impactCalculatedDepth: 7,
    impactPolicyMaxDepth: 7,
    // Demonstrates partial_depth (DEC-033/034): not everything was found,
    // and that stays visible even after every shown card has been reviewed —
    // there is no human override that turns this into "complete".
