...
- `npm run test` — зелёный, 16 test files / 82 tests.
...
- Структурирование фразы идёт через существующий LLM-provider; при недоступном LLM вопрос добавляется безопасным текстовым fallback.
