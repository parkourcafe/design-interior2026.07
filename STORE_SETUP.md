...
2. **Package name** — выбрать раз и навсегда, напр. `com.remhaos.app`
...
4. Package ID = ваш package name (`com.remhaos.app`).
...
# ответить на вопросы (packageId = com.remhaos.app), создастся keystore
...
```bash
# локально
npm run build && ANDROID_PACKAGE_NAME=com.remhaos.app \
