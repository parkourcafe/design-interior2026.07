...
--
-- Схема pi_test_fixture существует только в базах харнессов (DB4/DB5,
-- одноразовые стенды AP1/AP5). Здесь — только засев; функция засева не
-- выдана ни одной API-роли. Чтение ссылок для DB4/DB5 — отдельный файл
-- m3_handoff_refs_fixture.sql, на стенды AP5 он не попадает.
