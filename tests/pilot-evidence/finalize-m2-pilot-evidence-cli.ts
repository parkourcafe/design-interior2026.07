...
const [receiptPath, outputDir, pendingPath, koraReceiptPath, label, manifestPath] = process.argv.slice(2);
...
finalizeM2PilotEvidence(receipt, { outputDir, label, pending, pendingPath, koraReceiptPath, manifestPath });
